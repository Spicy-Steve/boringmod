...
public class NetherFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256247_) {
        ...
        FeatureUtils.register(
            p_256247_, LARGE_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(UniformInt.of(2, 3), UniformInt.of(5, 10))
        );
        FeatureUtils.register(
            p_256247_,
            BASALT_BLOBS,
        ...
        FeatureUtils.register(
            p_256247_, WARPED_FOREST_VEGETION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider1, 8, 4)
        );
        FeatureUtils.register(
