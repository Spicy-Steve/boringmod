...
public class VegetationPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> p_255657_) {
        ...
        PlacementUtils.register(
            p_255657_, PATCH_GRASS_BADLANDS, holder5, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
        ...
        PlacementUtils.register(
            p_255657_, PATCH_GRASS_TAIGA_2, holder6, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
        );
