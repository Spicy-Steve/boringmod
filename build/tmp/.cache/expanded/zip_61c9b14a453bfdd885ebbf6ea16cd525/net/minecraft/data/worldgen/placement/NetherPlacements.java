...
public class NetherPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> p_256373_) {
        ...
        PlacementUtils.register(
            p_256373_, GLOWSTONE, holder5, CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()
        );
        ...
        PlacementUtils.register(
            p_256373_, SPRING_OPEN, holder15, CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()
        );
