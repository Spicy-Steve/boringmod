...
public class TrialChambersStructurePools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> p_312354_) {
        HolderGetter<StructureTemplatePool> holdergetter = p_312354_.lookup(Registries.TEMPLATE_POOL);
        ...
        HolderGetter<StructureProcessorList> holdergetter1 = p_312354_.lookup(Registries.PROCESSOR_LIST);
        ...
        PoolAliasBindings.registerTargetsAsPools(p_312354_, holder, ALIAS_BINDINGS);
    }
}
