...
public class FunctionCommand {
    ...
    private static <T extends ExecutionCommandSource<T>> void instantiateAndQueueFunctions(
        ...
        try {
            InstantiatedFunction<T> instantiatedfunction = p_309610_.instantiate(p_309636_, p_309639_, p_309605_);
    ...
    private static <T extends ExecutionCommandSource<T>> CommandResultCallback decorateOutputIfNeeded(
        ...
        return p_309706_.isSilent() ? p_309608_ : (p_309477_, p_309478_) -> {
            p_309672_.signalResult(p_309706_, p_309690_, p_309478_);
            p_309608_.onSuccess(p_309478_);
        };
    }
