...
public class MacroFunction<T extends ExecutionCommandSource<T>> implements CommandFunction<T> {
    ...
    public InstantiatedFunction<T> instantiate(@Nullable CompoundTag p_305810_, CommandDispatcher<T> p_306149_, T p_306153_) throws FunctionInstantiationException {
        if (p_305810_ == null) {
            ...
            if (instantiatedfunction != null) {
                ...
                InstantiatedFunction<T> instantiatedfunction1 = this.substituteAndParse(this.parameters, list, p_306149_, p_306153_);
    ...
    private InstantiatedFunction<T> substituteAndParse(List<String> p_306226_, List<String> p_306024_, CommandDispatcher<T> p_306281_, T p_306083_) throws FunctionInstantiationException {
        ...
        for(MacroFunction.Entry<T> entry : this.entries) {
            ...
            list.add(entry.instantiate(list1, p_306281_, p_306083_, this.id));
        }
    ...
    interface Entry<T> {
        ...
        UnboundEntryAction<T> instantiate(List<String> p_305908_, CommandDispatcher<T> p_305826_, T p_306267_, ResourceLocation p_305778_) throws FunctionInstantiationException;
    }
    ...
    static class MacroEntry<T extends ExecutionCommandSource<T>> implements MacroFunction.Entry<T> {
        ...
        public MacroEntry(StringTemplate p_306131_, IntList p_306124_) {
        ...
        public UnboundEntryAction<T> instantiate(List<String> p_306061_, CommandDispatcher<T> p_306059_, T p_305895_, ResourceLocation p_306158_) throws FunctionInstantiationException {
            String s = this.template.substitute(p_306061_);

            try {
                return CommandFunction.parseCommand(p_306059_, p_305895_, new StringReader(s));
    ...
    static class PlainTextEntry<T> implements MacroFunction.Entry<T> {
        ...
        @Override
        public UnboundEntryAction<T> instantiate(List<String> p_306111_, CommandDispatcher<T> p_305941_, T p_306143_, ResourceLocation p_305903_) {
