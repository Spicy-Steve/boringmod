                        ...
                        for(T t : list) {
                            try {
                                ...
                                if (list1.size() + collection.size() >= i) {
                                    p_309567_.handleError(ERROR_FORK_LIMIT_REACHED.create(i), (boolean)custommodifierexecutor, p_305977_.tracer());
                                    return;
                                }

                                list1.addAll(collection);
                            } catch (CommandSyntaxException commandsyntaxexception) {
                                t.handleError(commandsyntaxexception, (boolean)custommodifierexecutor, p_305977_.tracer());
