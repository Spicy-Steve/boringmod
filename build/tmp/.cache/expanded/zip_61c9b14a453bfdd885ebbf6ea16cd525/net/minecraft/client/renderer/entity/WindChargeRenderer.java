...
public class WindChargeRenderer extends EntityRenderer<WindCharge> {
    ...
    public void render(WindCharge p_312893_, float p_311977_, float p_312685_, PoseStack p_312434_, MultiBufferSource p_312239_, int p_312700_) {
        float f = (float)p_312893_.tickCount + p_312685_;
        VertexConsumer vertexconsumer = p_312239_.getBuffer(RenderType.breezeWind(TEXTURE_LOCATION, this.xOffset(f) % 1.0F, 0.0F));
        this.model.setupAnim(p_312893_, 0.0F, 0.0F, f, 0.0F, 0.0F);
        this.model.renderToBuffer(p_312434_, vertexconsumer, p_312700_, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 0.5F);
        super.render(p_312893_, p_311977_, p_312685_, p_312434_, p_312239_, p_312700_);
    }
    ...
    public ResourceLocation getTextureLocation(WindCharge p_312402_) {
