...
public class BreezeDebugRenderer {
            ...
            .forEach(
                p_312675_ -> {
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::attackTarget)
                        ...
                        .ifPresent(
                            p_312926_ -> {
                                drawLine(p_312334_, p_312422_, p_312916_, p_312212_, p_312705_, p_312675_.position(), p_312926_, TARGET_LINE_COLOR);
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::jumpTarget)
                        .ifPresent(
                            p_311923_ -> {
                                drawLine(
                                    p_312334_, p_312422_, p_312916_, p_312212_, p_312705_, p_312675_.position(), p_311923_.getCenter(), JUMP_TARGET_LINE_COLOR
                                );
                                DebugRenderer.renderFilledBox(
                                    p_312334_,
                                    p_312422_,
                                    AABB.unitCubeFromLowerCorner(Vec3.atLowerCornerOf(p_311923_)).move(-p_312916_, -p_312212_, -p_312705_),
                                    1.0F,
                                    0.0F,
                                    0.0F,
                                    1.0F
    ...
    private static void drawLine(
        ...
        vertexconsumer.vertex(p_311968_.last().pose(), (float)(p_312653_.x - p_312731_), (float)(p_312653_.y - p_312933_), (float)(p_312653_.z - p_312347_))
            .color(p_311785_)
            .endVertex();
        vertexconsumer.vertex(p_311968_.last().pose(), (float)(p_312341_.x - p_312731_), (float)(p_312341_.y - p_312933_), (float)(p_312341_.z - p_312347_))
            .color(p_311785_)
            .endVertex();
    }
