...
public class BreezeRenderer extends MobRenderer<Breeze, BreezeModel<Breeze>> {
    ...
    public BreezeRenderer(EntityRendererProvider.Context p_312679_) {
        super(p_312679_, new BreezeModel<>(p_312679_.bakeLayer(ModelLayers.BREEZE)), 0.8F);
        this.addLayer(new BreezeWindLayer(this, p_312679_.getModelSet(), WIND_TEXTURE_LOCATION));
        this.addLayer(new BreezeEyesLayer(this, p_312679_.getModelSet(), TEXTURE_LOCATION));
    }
