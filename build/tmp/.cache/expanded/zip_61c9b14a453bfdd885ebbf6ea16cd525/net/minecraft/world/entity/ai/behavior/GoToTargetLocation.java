        ...
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_311591_, p_311592_, p_311593_) -> {
                            ...
                            boolean flag = blockpos.closerThan(p_311592_.blockPosition(), (double)p_259740_);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_311592_, getNearbyPos(p_311592_, blockpos), p_259957_, p_259740_);
                            }
