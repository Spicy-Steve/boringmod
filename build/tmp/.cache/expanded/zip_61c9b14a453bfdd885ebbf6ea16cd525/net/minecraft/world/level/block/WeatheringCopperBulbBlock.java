...
public class WeatheringCopperBulbBlock extends CopperBulbBlock implements WeatheringCopper {
    ...
    @Override
    public void randomTick(BlockState p_309163_, ServerLevel p_309177_, BlockPos p_309033_, RandomSource p_308946_) {
        this.changeOverTime(p_309163_, p_309177_, p_309033_, p_308946_);
    }

    @Override
    public boolean isRandomlyTicking(BlockState p_308966_) {
