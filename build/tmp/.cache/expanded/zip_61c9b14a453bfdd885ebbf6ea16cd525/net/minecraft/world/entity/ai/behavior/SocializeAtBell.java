                    ...
                    .apply(
                        ...
                        (p_258750_, p_258751_, p_258752_, p_258753_, p_258754_) -> (p_258766_, p_258767_, p_258768_) -> {
                                ...
                                if (p_258766_.getRandom().nextInt(100) == 0
                                    ...
                                    && nearestvisiblelivingentities.contains(p_308670_ -> EntityType.VILLAGER.equals(p_308670_.getType()))) {
                                    nearestvisiblelivingentities.findClosest(
                                            p_308669_ -> EntityType.VILLAGER.equals(p_308669_.getType()) && p_308669_.distanceToSqr(p_258767_) <= 32.0
                                        )
                                        .ifPresent(p_258759_ -> {
