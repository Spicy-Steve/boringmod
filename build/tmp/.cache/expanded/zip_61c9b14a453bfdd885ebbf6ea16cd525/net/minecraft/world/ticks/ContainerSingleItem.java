...
public interface ContainerSingleItem extends Container {
    ...
    ItemStack splitTheItem(int p_304641_);
    ...
    @Override
    default boolean stillValid(Player p_304856_) {
        return Container.stillValidBlockEntity(this.getContainerBlockEntity(), p_304856_);
    }
}
