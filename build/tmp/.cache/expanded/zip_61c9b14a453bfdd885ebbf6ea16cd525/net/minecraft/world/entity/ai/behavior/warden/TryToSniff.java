    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_259979_ -> p_259979_.group(
                    ...
                    .apply(p_259979_, (p_260219_, p_260252_, p_260090_, p_259577_, p_260020_) -> (p_309508_, p_309509_, p_309510_) -> {
                            p_260219_.set(Unit.INSTANCE);
                            p_260090_.setWithExpiry(Unit.INSTANCE, (long)SNIFF_COOLDOWN.sample(p_309508_.getRandom()));
                            p_260252_.erase();
                            p_309509_.setPose(Pose.SNIFFING);
                            return true;
                        })
        );
    }
