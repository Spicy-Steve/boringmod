...
public class RecipeCache {
    ...
    public Optional<CraftingRecipe> get(Level p_307315_, CraftingContainer p_307684_) {
    ...
    private Optional<CraftingRecipe> compute(CraftingContainer p_307329_, Level p_307202_) {
        ...
        this.insert(p_307329_.getItems(), optional.map(RecipeHolder::value).orElse(null));
    ...
    private void insert(List<ItemStack> p_307307_, @Nullable CraftingRecipe p_307338_) {
        ...
        this.entries[0] = new RecipeCache.Entry(nonnulllist, p_307338_);
    }
        ...
        public boolean matches(List<ItemStack> p_307411_) {
            if (this.key.size() != p_307411_.size()) {
                ...
                for(int i = 0; i < this.key.size(); ++i) {
                    if (!ItemStack.isSameItemSameTags(this.key.get(i), p_307411_.get(i))) {
                        return false;
                    }
                }
