    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_258884_ -> p_258884_.group(
                    ...
                    .apply(
                        p_258884_,
                        (p_258886_, p_258887_, p_258888_) -> (p_313642_, p_313643_, p_313644_) -> {
                                boolean flag = p_258884_.tryGet(p_258886_).isPresent()
                                    || p_258884_.tryGet(p_258888_).isPresent()
                                    || p_258884_.<LivingEntity>tryGet(p_258887_).filter(p_259890_ -> p_259890_.distanceToSqr(p_313643_) <= 36.0).isPresent();
                                if (!flag) {
                                    p_258886_.erase();
                                    p_258887_.erase();
                                    p_313643_.getBrain().updateActivityFromSchedule(p_313642_.getDayTime(), p_313642_.getGameTime());
                                }
