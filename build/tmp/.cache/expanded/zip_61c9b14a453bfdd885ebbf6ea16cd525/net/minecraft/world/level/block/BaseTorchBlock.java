...
public abstract class BaseTorchBlock extends Block {
    ...
    @Override
    public VoxelShape getShape(BlockState p_304673_, BlockGetter p_304919_, BlockPos p_304930_, CollisionContext p_304757_) {
        return AABB;
    }
    ...
    @Override
    public boolean canSurvive(BlockState p_304413_, LevelReader p_304885_, BlockPos p_304808_) {
