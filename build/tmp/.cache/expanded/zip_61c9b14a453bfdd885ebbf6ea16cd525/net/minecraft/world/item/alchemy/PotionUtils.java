...
public class PotionUtils {
    ...
    public static void addPotionTooltip(ItemStack p_43556_, List<Component> p_43557_, float p_43558_, float p_314708_) {
        addPotionTooltip(getMobEffects(p_43556_), p_43557_, p_43558_, p_314708_);
    }
        ...
        if (p_259687_.isEmpty()) {
            ...
            for(MobEffectInstance mobeffectinstance : p_259687_) {
                ...
                if (!mobeffectinstance.endsWithin(20)) {
                    mutablecomponent = Component.translatable(
                        "potion.withDuration", mutablecomponent, MobEffectUtil.formatDuration(mobeffectinstance, p_259949_, p_314717_)
                    );
                }
