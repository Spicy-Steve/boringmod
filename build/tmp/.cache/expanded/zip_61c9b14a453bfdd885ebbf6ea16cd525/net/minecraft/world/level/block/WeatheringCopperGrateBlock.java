...
public class WeatheringCopperGrateBlock extends WaterloggedTransparentBlock implements WeatheringCopper {
    ...
    @Override
    public void randomTick(BlockState p_309111_, ServerLevel p_309121_, BlockPos p_309090_, RandomSource p_308865_) {
        this.changeOverTime(p_309111_, p_309121_, p_309090_, p_308865_);
    }

    @Override
    public boolean isRandomlyTicking(BlockState p_309102_) {
