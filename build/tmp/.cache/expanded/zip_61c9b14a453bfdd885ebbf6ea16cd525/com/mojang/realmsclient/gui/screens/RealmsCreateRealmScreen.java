...
public class RealmsCreateRealmScreen extends RealmsScreen {
    ...
    private void createWorld(RealmsServer p_305781_) {
        WorldCreationTask worldcreationtask = new WorldCreationTask(p_305781_.id, this.nameBox.getValue(), this.descriptionBox.getValue());
        RealmsResetWorldScreen realmsresetworldscreen = RealmsResetWorldScreen.forNewRealm(
            this, p_305781_, worldcreationtask, () -> this.minecraft.execute(() -> {
