...
public class BoringstandGUIScreen extends AbstractContainerScreen<BoringstandGUIMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("boringmod:textures/screens/boring_stand_1.png"), this.leftPos + 42, this.topPos + 13, 0, 0, 44, 20, 44, 20);

		guiGraphics.blit(new ResourceLocation("boringmod:textures/screens/.png"), this.leftPos + 81, this.topPos + 38, 0, 0, 28, 21, 28, 21);
