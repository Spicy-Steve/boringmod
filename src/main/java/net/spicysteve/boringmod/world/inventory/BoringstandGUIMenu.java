...
public class BoringstandGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BoringstandGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
